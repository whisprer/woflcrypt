...
sht_dir = hex_to_txt(hex_dir).lower()  # Ensure lowercase for direction comparison
...
print(f"Rotation direction: {sht_dir}")
...
rotated_val = rot_hex(hex_msg, rot_val, direction=sht_dir)
